...
private:
    ...
    Array blips_config_; // Array of dictionaries with position, color, size
...
public:
    ...
    // Set blips configuration from inspector
    void set_blips_config(Array p_config);
